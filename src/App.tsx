              ...
              <section className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
                ...
                {!analysisAvailable && healthChecked && (
                  <p className="mt-2 text-xs leading-relaxed text-slate-500">
                    Analisis langsung belum dikonfigurasi. Anda tetap dapat
                    mempelajari alur dan hasil melalui empat demo offline.
                  </p>
                )}
                ...
                <button
                  type="button"
                  onClick={() => loadDemo(activeDemo ?? 0, true)}
                  disabled={isLoading}
